...
static AppInfo apps[] = {
    ...
    {"Nvidia Open", "nvidia.png", "curl -fsSL -o /tmp/nvidia-install.sh https://codeberg.org/Neko-Void/nvidia-support/raw/branch/main/install.sh && pkexec bash /tmp/nvidia-install.sh open", GROUP_DRIVERS, FALSE, FALSE},
    {"Nvidia Proprietary Lastest", "nvidia.png", "curl -fsSL -o /tmp/nvidia-install.sh https://codeberg.org/Neko-Void/nvidia-support/raw/branch/main/install.sh && pkexec bash /tmp/nvidia-install.sh latest", GROUP_DRIVERS, FALSE, FALSE},
    {"Nvidia Proprietary 580", "nvidia.png", "curl -fsSL -o /tmp/nvidia-install.sh https://codeberg.org/Neko-Void/nvidia-support/raw/branch/main/install.sh && pkexec bash /tmp/nvidia-install.sh 580", GROUP_DRIVERS, FALSE, FALSE},
    {"Nvidia Proprietary 470", "nvidia.png", "curl -fsSL -o /tmp/nvidia-install.sh https://codeberg.org/Neko-Void/nvidia-support/raw/branch/main/install.sh && pkexec bash /tmp/nvidia-install.sh 470", GROUP_DRIVERS, FALSE, FALSE},
    {"Nvidia Proprietary 390", "nvidia.png", "curl -fsSL -o /tmp/nvidia-install.sh https://codeberg.org/Neko-Void/nvidia-support/raw/branch/main/install.sh && pkexec bash /tmp/nvidia-install.sh 390", GROUP_DRIVERS, FALSE, FALSE},
