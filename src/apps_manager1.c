...
static AppInfo apps[] = {
    // Gaming
    {"Steam", "steam.png", "pkexec xbps-install -Syu void-repo-nonfree void-repo-multilib void-repo-multilib-nonfree && pkexec xbps-install -Sy steam-udev-rules libGL-32bit libpulseaudio-32bit libtxc_dxtn-32bit mesa-dri mesa-dri-32bit steam-nk", GROUP_GAMING, FALSE, FALSE},
    ...
    {"AMD Drivers", "amd.png", "pkexec xbps-install -Sy mesa-dri mesa-dri-32bit mesa-vulkan-radeon nvtop LACT mesa-vulkan-radeon-32bit linux-firmware-amd", GROUP_DRIVERS, FALSE, FALSE},
    ...
    {"Nvidia Nouveau", "nvidia.png", "pkexec xbps-install -Sy mesa-dri mesa-dri-32bit mesa-nouveau-dri mesa-vulkan-nouveau", GROUP_DRIVERS, FALSE, FALSE},
